...
model.add(layers.Conv2D(6, (5, 5), padding='same', activation = 'sigmoid', input_shape = (height,width,1)))
...
#train the network
history = model.fit(X_train_par, y_train_par, epochs = 40, batch_size = 128, validation_data=(X_train_val, y_train_val))
