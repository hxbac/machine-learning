...
# 1.read dataset
import pandas as pd
df = pd.read_excel ('du-lieu-dieu-tra-diem.xlsx',sheet_name='KHTN_2017_2018')

# split dataset into train and test
num_train_samples = 80
X_train, X_test = df.iloc[0:num_train_samples,4:10].values, df.iloc[num_train_samples:,4:10].values
y_train, y_test = df.iloc[0:num_train_samples,10].values, df.iloc[num_train_samples:,10].values
#============================================================================
# 2. Scale dataset
#=============================================================================
...
history = model.fit(X_train, y_train, epochs=500, verbose=0, validation_split= 0.05)
