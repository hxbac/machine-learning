...
X_train = X_train.reshape((num_train_samples, height, width,3))
X_train = X_train.astype('float32') / 255
X_test = X_test.reshape((num_test_samples, height, width,3))
...
model.add(layers.Conv2D(96, (11, 11), strides = 1, activation='relu', input_shape=(height,width,3)))
...
#train the network
history = model.fit(X_train_par, y_train_par, epochs = 10, batch_size = 128, validation_data=(X_train_val, y_train_val))
